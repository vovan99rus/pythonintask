...
Вам нужно распределить 30 очков между 4 характеристиками:
 Мудрость,Сила, Здоровье, Ловкость. Вы можете как и брать из общего
...
point=30
chislo=0
print("Если хотите изменить Силу, то напишите Сила,остальные анологично.")
while True:
